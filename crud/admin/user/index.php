			...
			<div class="table-title">
				...
				<div class="row">
					...
					<div class="col-sm-6 text-start" style="margin: 15px 0;">
						<a href="#addEmployeeModal" class="btn btn-success " data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Tambahkan user</span></a>
			...
			<form method="POST" action="insert.php">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input type="password" class="form-control" name="psw"  required></input>
					</div>
					<div class="form-group">
						<label>Role</label>
						<input type="text" class="form-control" name="role"  required></input>
					</div>
				</div>
